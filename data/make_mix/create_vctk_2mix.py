...
mix_lists = [ ('./vctk_info/vctk_mix_2_spk_tr.txt', 'tr'),
              ('./vctk_info/vctk_mix_2_spk_cv.txt', 'cv'),
              ('./vctk_info/vctk_mix_2_spk_tt.txt', 'tt') ]


args = arg_parse()
#vctk_root = '/home/riviera1020/Big/Corpus/VCTK-Corpus/'
#out_dir = '/home/riviera1020/Big/Corpus/vctk-mix/wav8k/'
