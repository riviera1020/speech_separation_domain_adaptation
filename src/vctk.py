...
class VCTK(Dataset):
    ...
    def __init__(self, id_list_path, audio_root, seg_len = 1.0, pre_load = True, one_chunk_in_utt = True, mode = 'tr'):
        """
        Args:
            id_list_path     : id_list from data/vctk/preprocess.py
...
class VCTK_eval(Dataset):

    def __init__(self, id_list_path, audio_root, pre_load = True):
        """
        Args:
            id_list_path     : id_list from data/VCTK/preprocess.py
            audio_root       : root dir for VCTK dataset
            pre_load         : pre load all audio into RAM
        """
        super(VCTK_eval, self).__init__()
...
if __name__ == '__main__':
    ...
    trainset = VCTK('./data/vctk/id_list/tr.pkl', root, seg_len = 2.0, pre_load = False, one_chunk_in_utt = True)
    print(len(trainset))
